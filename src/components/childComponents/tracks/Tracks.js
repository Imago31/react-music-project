...
import backendTracks from '../../backendTracks'
                        ...
                        <div className="playlist__track track">
                            <div className="track__title">
                                ...
                                <div className="track__title-text">
                                    <a className="track__title-link" href="http://">{track.track}<span className="track__title-span"></span></a>
                                </div>
                            </div>
                            <div className="track__author">
                                <a className="track__author-link" href="http://">{track.singer}</a>
                            </div>
